#!/bin/sh
civo apikey add Demo_Test_Key JzYxOpM2qdU4FbyXPRZoKk0BgAv7H5Wwlcm3Dji1VnSCtsTeLN
...
download() {
  ...
  TARGETFILE="/tmp/civo-0.7.2-linux-arm.tar.gz"
  echo "Downloading package $URL to $TARGETFILE"

  curl -sSL "https://github.com/civo/cli/releases/download/v0.7.2/civo-0.7.2-linux-arm.tar.gz" --output "$TARGETFILE"
